...
- Timestamp: `2022-06-06 17:56`
- Build ID: `3bd9f814-f8d8-40f0-b812-3c67b37b7f50`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3bd9f814-f8d8-40f0-b812-3c67b37b7f50.git
$ cd 3bd9f814-f8d8-40f0-b812-3c67b37b7f50
```
